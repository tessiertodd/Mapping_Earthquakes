...
// This function determins the color of the circle based on magnitude of earthquake
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    // We set the style for each cicleMarker using out StyleInfo function
    style: styleInfo,
...
// The add all the details for the legend.
